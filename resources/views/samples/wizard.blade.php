    ...
    <div class="stepper mb-4">
        <div class="d-flex justify-content-between">
            <div class="d-flex flex-column align-items-center stepper-item active" data-step="1">
                <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center step-circle"
            ...
            <div class="d-flex flex-column align-items-center stepper-item" data-step="2">
                <div class="rounded-circle border border-secondary text-secondary d-flex align-items-center justify-content-center step-circle"
                ...
                <div class="mb-3">
                    ...
                    <div id="new-client-form" class="d-none mt-2">
                        <div class="input-group">
                            <input type="text" id="new-client-name" class="form-control"
                ...
                <div class="border rounded p-3 bg-light">
                    @forelse(App\Models\Method::all() as $method)
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="method_ids[]" value="{{ $method->id }}"
                                id="method-{{ $method->id }}">
                            <label class="form-check-label" for="method-{{ $method->id }}">
                                {{ $method->name }}@if($method->version) <span
                                class="text-muted">(v{{ $method->version }})</span>@endif
                            </label>
                        </div>
                    @empty
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Unit</th>
                                <td id="review-unit">-</td>
                            </tr>
                            <tr>
                                <th>Methods</th>
                                <td id="review-methods">-</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<style>
    ...
    .stepper .stepper-item.active .step-circle {
        background-color: #0d6efd !important;
        border: none !important;
        color: white !important;
    }

    .stepper .stepper-item.completed .step-circle {
